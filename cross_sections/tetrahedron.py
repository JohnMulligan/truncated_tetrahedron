...
y_offset=cos(math.pi/6)*r
x_offsets=sin(math.pi/6)/2
...
for v in bottom_vs:
	...
	if n==0:
		...
		x=-x_offsets+previous_offset+n*[s,l][n%2]
	vertices[v]=Point3D(x,-y_offset,0)

print(vertices)

'''triangles=[	['A','B','H'],['H','I','B'],['B','I','C'],['C','I','J'],
			['C','J','K'],['C','D','K'],['D','E','L'],['E','K','L'],
			['E','L','F'],['F','L','M'],['F','M','G'],['G','M','N']
		]
'''

triangles=[['A','B','H'],['H','I','B']]
#ABCDEFGHIJKLMN

graph(vertices,triangles,'ABHI')
##############
