...
vertex(X_Y_x[t],X_Y_y[t],X_Y_z[t]);
endShape(CLOSE);
beginShape();
vertex(X_x[t],X_y[t],X_z[t]);
vertex(X_Y_x[t],X_Y_y[t],X_Y_z[t]);
...
vertex(X_Y_x[t],X_Y_y[t],X_Y_z[t]);
vertex(Y_x[t],Y_y[t],Y_z[t]);
vertex(Z_x[t],Z_y[t],Z_z[t]);
vertex(Z_AA_x[t],Z_AA_y[t],Z_AA_z[t]);
endShape(CLOSE);
beginShape();
vertex(AA_x[t],AA_y[t],AA_z[t]);
vertex(Z_x[t],Z_y[t],Z_z[t]);
vertex(Z_AA_x[t],Z_AA_y[t],Z_AA_z[t]);
endShape(CLOSE);
beginShape();
vertex(AA_x[t],AA_y[t],AA_z[t]);
vertex(AB_x[t],AB_y[t],AB_z[t]);
vertex(AB_AC_x[t],AB_AC_y[t],AB_AC_z[t]);
vertex(Z_AA_x[t],Z_AA_y[t],Z_AA_z[t]);
endShape(CLOSE);
beginShape();
vertex(AB_x[t],AB_y[t],AB_z[t]);
vertex(AB_AC_x[t],AB_AC_y[t],AB_AC_z[t]);
vertex(AC_x[t],AC_y[t],AC_z[t]);
endShape(CLOSE);
beginShape();
vertex(AB_AC_x[t],AB_AC_y[t],AB_AC_z[t]);
vertex(AC_x[t],AC_y[t],AC_z[t]);
vertex(AD_x[t],AD_y[t],AD_z[t]);
vertex(last_x[t],last_y[t],last_z[t]);
endShape(CLOSE);
beginShape();
vertex(AD_x[t],AD_y[t],AD_z[t]);
vertex(AE_x[t],AE_y[t],AE_z[t]);
vertex(last_x[t],last_y[t],last_z[t]);
endShape(CLOSE);